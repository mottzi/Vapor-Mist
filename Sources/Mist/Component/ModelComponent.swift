...
public extension ModelComponent {
    ...
    func render(with modelID: UUID, state: ComponentState? = nil, on db: Database, using renderer: ViewRenderer) async -> String? {
    ...
    func makeContext(using modelID: UUID, state: ComponentState? = nil, on db: Database) async -> ComponentContext? {
