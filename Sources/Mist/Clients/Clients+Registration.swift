...
extension Clients {
    ...
    /// Sends a close frame to every connected client and waits for their channels to fully close.
    /// Returns once all channels have closed or after 5 seconds, whichever comes first.
    func closeAll() async {
